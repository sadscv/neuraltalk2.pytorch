...
def main(params):
    ...
    for i, img in enumerate(image_id_lines):
        ...
        jimg = {}
        jimg['split'] = 'train'
        jimg['file_path'] = os.path.join(FILE_DIR + 'caption_train_images_20170902/',
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='/home/chen/open/challenger/total_caption.txt.seg',
